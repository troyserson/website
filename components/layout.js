      ...
      <div className="flex">
        <Link href={layout.footer.icon[0].href} passHref legacyBehavior>
          <a target="_blank" rel="noopener noreferrer" aria-label={layout.footer.icon[0].label}>
            <svg className="opacity-80 hover:text-opacity-90 drop-shadow-sm hover:drop-shadow-md transition ease-in duration-300 w-7 h-7 mr-6" fill="currentColor" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
